...
aliases['nCleanGenJet'] = {
    ...
    'linesToAdd': ['.L /afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/examples/Full2016_noHIPM/ngenjet.cc+'],
    'class': 'CountGenJet',
...
aliases['getGenZpt_OTF'] = {
    ...
    'linesToAdd': ['.L /afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/examples/Full2016_noHIPM/getGenZpt.cc+'],
    'class': 'getGenZpt',
...
#aliases['SFweight'] = {
#    'expr': ' * '.join(['SFweight2l', 'LepWPCut', 'LepWPSF','PrefireWeight','Jet_PUIDSF', 'btagSF']),
#    'samples': mc
#}
...
aliases['Weight2MINLO'] = {
    ...
    'linesToAdd': ['.L /afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/examples/Full2016_noHIPM/weight2MINLO.cc+'],
    'class': 'Weight2MINLO',
...
####
#### Higgs Polarization Matrix Element reweight
####
...
aliases['D_ME'] = {
  'linesToProcess':['ROOT.gSystem.Load("/afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/JHUGenMELA/MELA/data/slc7_amd64_gcc920/libmcfm_708.so","", ROOT.kTRUE);',
                    ...
                    'ROOT.gSystem.Load("/afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/examples/Full2016_noHIPM/RecoMELA_VBF_cc.so","", ROOT.kTRUE);',
...
aliases['BDTG4D3_VBF'] = {
    'linesToAdd' : [
        ...
        '.L /afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/examples/Full2016_noHIPM/TMVA_VBF_2J.cc+'],
    'class' : 'TMVA_HWW_VBF',
