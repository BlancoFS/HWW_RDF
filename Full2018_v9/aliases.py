...
aliases['nCleanGenJet'] = {
    ...
    'linesToAdd': ['.L /afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/examples/Full2018_v9/ngenjet.cc+'],
    'class': 'CountGenJet',
...
aliases['getGenZpt_OTF'] = {
    ...
    'linesToAdd': ['.L /afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/examples/Full2018_v9/getGenZpt.cc+'],
    'class': 'getGenZpt',
...
aliases['Weight2MINLO'] = {
    ...
    'linesToAdd': ['.L /afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/examples/Full2018_v9/weight2MINLO.cc+'],
    'class': 'Weight2MINLO',
...
aliases['D_ME'] = {
  'linesToProcess':['ROOT.gSystem.Load("/afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/JHUGenMELA/MELA/data/slc7_amd64_gcc920/libmcfm_708.so","", ROOT.kTRUE);',
                    ...
                    'ROOT.gSystem.Load("/afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/examples/Full2018_v9/RecoMELA_VBF_cc.so","", ROOT.kTRUE);',
