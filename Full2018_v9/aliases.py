...
aliases['CleanJet_VetoMap'] = {
    'linesToAdd': [".L /afs/cern.ch/work/s/sblancof/private/Run2Analysis/AlmaLinux9_mkShapes/mkShapesRDF/examples/Full2018_v9/jet_veto_2018.cc+"],
    'class' : 'Jet_Veto',
...
aliases['HWW_interference'] = {
    ...
    #'exprSlot': ['b(nLHEPart,LHEPart_pt,LHEPart_eta,LHEPart_phi,LHEPart_mass,LHEPart_incomingpz,LHEPart_pdgId,LHEPart_status,LHEPart_spin,GenPart_genPartIdxMother,GenPart_pdgId,GenPart_status,GenPart_pt,GenPart_eta,GenPart_phi,GenPart_mass,Generator_x1,Generator_x2,Generator_id1,Generator_id2)',
    #             ['nLHEPart','LHEPart_pt','LHEPart_eta','LHEPart_phi','LHEPart_mass','LHEPart_incomingpz','LHEPart_pdgId','LHEPart_status','LHEPart_spin','GenPart_genPartIdxMother','GenPart_pdgId','GenPart_status','GenPart_pt','GenPart_eta','GenPart_phi','GenPart_mass','Generator_x1','Generator_x2','Generator_id1','Generator_id2']],
...
aliases['ggHWW_Interference'] = {
    ...
    #'exprSlot': ['(HWW_interference[1]-HWW_interference[0]-HWW_interference[2]) / (HWW_interference[0]+HWW_interference[2])', ['HWW_interference']],
...
aliases['ggHWW_Total'] = {
    ...
    #'exprSlot': ['HWW_interference[1] / (HWW_interference[0]+HWW_interference[2])', ['HWW_interference']],
    'samples': ['ggH_gWW_Int', 'ggH_gWW_Tot', 'ggH_Int', 'ggH_Tot', 'ggWW_Int', 'ggWW_Tot'],
}
...
aliases['qqHWW_Interference'] = {
    ...
    #'exprSlot': ['(HWW_interference[3]+HWW_interference[5])!=0.0 ? (HWW_interference[4]-HWW_interference[3]-HWW_interference[5]) / (HWW_interference[3]+HWW_interference[5]) : 0.0', ['HWW_interference']],
...
aliases['qqHWW_Total'] = {
    ...
    #'exprSlot': ['(HWW_interference[3]+HWW_interference[5])!=0.0 ? HWW_interference[4] / (HWW_interference[3]+HWW_interference[5]) : 1.0', ['HWW_interference']],
    'samples': ['qqH_qqWW_Int', 'qqH_qqWW_Tot'],
}
