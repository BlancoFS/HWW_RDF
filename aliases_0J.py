...
aliases['Higgs_WW_Rew'] = {
    #'linesToAdd' : ['/afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/examples/Full2017_v9/doHiggsPolarization.cc'],
    ...
    'samples' : ['ggH_HWLWL', 'ggH_HWTWT', 'ggH_HWW_Int', 'ggH_HWW_TTInt'],
}
...
aliases['BDTG4D3_0J'] = {
    #'linesToAdd' : ['/afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/examples/Full2017_v9/TMVA_GGF_0J.cc'],
    'linesToAdd' : ['.L /afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/examples/Full2017_v9/TMVA_GGF_0J.cc+'],
    'class' : 'TMVA_HWW_0J',
...
aliases['BDTG4D3_Pol'] = {
    #'linesToAdd' : ['/afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/examples/Full2017_v9/TMVA_GGF_Pol.cc'],
    'linesToAdd' : ['.L /afs/cern.ch/work/s/sblancof/private/Run2Analysis/mkShapesRDF/examples/Full2017_v9/TMVA_GGF_Pol.cc+'],
    'class' : 'TMVA_HWW_Pol',
